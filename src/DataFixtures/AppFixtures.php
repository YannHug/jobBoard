...
{
    private const TAGS = ['PHP', 'SYMFONY', 'LARAVEL', 'JS', 'REACT', 'VUE', 'ANGULAR', 'JAVA', 'PYTHON', 'C#', 'C++', 'RUBY', 'GO', 'TYPESCRIPT', 'SQL'];
    private const SERVICES = ['DEV', 'DESIGN', 'DEVOPS', 'DATA', 'SECURITY', 'BIG DATA', 'IA', 'BI', 'CRM', 'ERP', 'MARKETING', 'BRANDING', 'GAME DESIGN'];
    ...
    private function randomService(ObjectManager $manager): Service
    {
        return $manager->getRepository(Service::class)->findByNom(
            self::SERVICES[array_rand(self::SERVICES)]
        )[0];
    }
